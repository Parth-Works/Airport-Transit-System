...
mu=1; % modified service rate for PHASE 1
mu1=10; % service rate of PHASE 1
mu2=8; % service rate of PHASE 2
...
%%           Plotting Analysis         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%figure; plot(A),hold on, plot(A2), hold on, plot(D);
...
figure; plot(MU), title('modified service rate for phase-1'), axis([0 700 0 40]);
